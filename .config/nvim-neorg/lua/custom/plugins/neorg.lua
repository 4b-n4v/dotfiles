return {
  ...
  vim.keymap.set('n', '<leader>nn', '<CMD>Neorg<CR>', { desc = '[N]eorg' }),
  ...
  vim.keymap.set('n', '<leader>ntt', '<CMD>Neorg toc<CR>', { desc = '[N]eorg [T]oggle [T]OC' }),
  vim.keymap.set('n', '<leader>ngs', '<CMD>Neorg generate-workspace-summary<CR>', { desc = '[N]eorg [G]enerate Worskpace [S]ummary' }),
